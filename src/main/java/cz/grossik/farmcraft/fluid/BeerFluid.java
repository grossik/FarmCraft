package cz.grossik.farmcraft.fluid;
...
public abstract class BeerFluid extends FlowingFluid {
	@Override
   public Fluid getFlowingFluid() {
      return FluidInit.beer_fluid_flowing.get();
   }

   @Override
   public Fluid getStillFluid() {
      return FluidInit.beer_fluid.get();
   }

   @Override
   public Item getFilledBucket() {
      return ItemInit.bucket_beer.get();
   }
   ...
   public BlockState getBlockState(IFluidState state) {
      return BlockInit.beer_block.get().getDefaultState().with(FlowingFluidBlock.LEVEL, Integer.valueOf(getLevelFromState(state)));
   }

   @Override
   public boolean isEquivalentTo(Fluid fluidIn) {
      return fluidIn == FluidInit.beer_fluid.get() || fluidIn == FluidInit.beer_fluid_flowing.get();
   }
   ...
   public boolean canDisplace(IFluidState p_215665_1_, IBlockReader p_215665_2_, BlockPos p_215665_3_, Fluid p_215665_4_, Direction p_215665_5_) {
      return p_215665_5_ == Direction.DOWN && !p_215665_4_.isIn(FluidInit.Tags.beer);
   }
   ...
   protected float getExplosionResistance() {
	...
	protected FluidAttributes createAttributes() {
		return FluidAttributes.builder(new ResourceLocation(Main.MOD_ID, "blocks/beer_still"),
				new ResourceLocation(Main.MOD_ID, "blocks/beer_flow"))
		.translationKey("block.farmcraft.beer")
		.build(this);
	}
