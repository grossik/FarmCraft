...
import cz.grossik.farmcraft.recipe.JuicerRecipeGui;
...
@OnlyIn(Dist.CLIENT)
public class JuicerScreen<JuicerContainer extends AbstractJuicerContainer> extends ContainerScreen<JuicerContainer> implements IRecipeShownListener {
   ...
   private static final ResourceLocation FURNACE_GUI_TEXTURES = new ResourceLocation(Main.MOD_ID, "textures/gui/container/juicer.png");
   
   public JuicerScreen(JuicerContainer p_i51089_1_, PlayerInventory p_i51089_2_, ITextComponent p_i51089_3_) {
	   super(p_i51089_1_, p_i51089_2_, p_i51089_3_);
	   this.field_214088_k = new JuicerRecipeGui();
   ...
   public void init() {
      ...
      this.field_214088_k.init(this.width, this.height, this.minecraft, this.field_214090_m, this.container);
      ...
      /*this.addButton((new ImageButton(this.guiLeft + 20, this.height / 2 - 49, 20, 18, 0, 0, 19, field_214089_l, (p_214087_1_) -> {
         this.field_214088_k.initSearchBar(this.field_214090_m);
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      if (((AbstractJuicerContainer)this.container).func_217061_l()) {
         int k = ((AbstractJuicerContainer)this.container).getBurnLeftScaled();
         //k je cim dal mensi
         /* 
          1 - x leva
          2 - y spodni
      ...
      int l = ((AbstractJuicerContainer)this.container).getCookProgressionScaled();
